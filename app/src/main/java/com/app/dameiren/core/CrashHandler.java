...
import com.app.dameiren.ui.MainActivity;
import com.app.dameiren.ui.login.LoginActivity;
import com.app.dameiren.utils.ActivityControl;
import com.litesuits.common.io.FileUtilsKJ;
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    // log文件的后缀名
    public static final String FILE_NAME_SUFFIX = "crash"+ SystemTool.getDataTime("yyyyMMddHHmmss")+".log";
    ...
    public void uncaughtException(Thread thread, final Throwable ex) {
        // 导出异常信息到SD卡中
        try {
//            ActivityControl.getInstance(mContext.getApplicationContext()).startNew(com.app.dameiren.ui.login.LoginActivity.class);
            saveToSDCard(ex);
        } catch (Exception e) {
        } finally {
...
//     }
    ...
    private void saveToSDCard(Throwable ex) throws Exception {
        File file = FileUtilsKJ.getSaveFile(AppConfig.saveFolder+AppConfig.crashFolder,
                FILE_NAME_SUFFIX);
