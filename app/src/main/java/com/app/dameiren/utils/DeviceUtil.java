...
public class DeviceUtil {
	...
	private static volatile DeviceUtil instance = null;
	...
	public String getContextName() {
		...
		try {
			...
			return StringUtils.nullStrToEmpty(appName);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String getDeviceId() {
		...
		return StringUtils.nullStrToEmpty(deviceId);
	}
	...
	public String getIMEI() {
		...
		try {
			...
			return StringUtils.nullStrToEmpty(IMEI);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String getIMSI() {
		...
		try {
			...
			return StringUtils.nullStrToEmpty(IMSI);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String getPhoneNumber() {
		...
		try {
			...
			return StringUtils.nullStrToEmpty(phoneNo);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String getNetProvider() {
		...
		try {
			...
			return StringUtils.nullStrToEmpty(netWorkOperator);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String getSIM() {
		...
		try {
			...
			return StringUtils.nullStrToEmpty(SIM);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String getProductModel() {
		...
		try {
			...
			return StringUtils.nullStrToEmpty(productModel);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String getOSVersion() {
		...
		try {
			...
			return StringUtils.nullStrToEmpty(osVer);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String getMacAddress() {
		...
		try {
			...
			return StringUtils.nullStrToEmpty(macAddress);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String getVersionName() {
		...
		try {
			...
			return StringUtils.nullStrToEmpty(verName);
	...
	public String getPackageName() {
		...
		try {
			...
			return StringUtils.nullStrToEmpty(pkgName);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String getResolution() {
		...
		try {
			...
			return StringUtils.nullStrToEmpty(resolution);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String getMetaValue(String metakey) {
		...
		if (mContext == null || StringUtils.isEmpty(metakey)) {
		...
		try {
			...
			return StringUtils.nullStrToEmpty(value);
		} catch (Exception e) {
			e.printStackTrace();
