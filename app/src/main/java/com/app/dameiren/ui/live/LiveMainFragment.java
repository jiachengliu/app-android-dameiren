package com.app.dameiren.ui.live;
...
//                indicator.setScrollBar(new LayoutBar(getApplicationContext(), R.layout.layout_slidebar, ScrollBar.Gravity.CENTENT_BACKGROUND));
        ...
        int selectColor = res.getColor(R.color.colorPrimary);
        int unSelectColor = res.getColor(R.color.colorPrimaryDark);
    ...
    private class MyAdapter extends IndicatorViewPager.IndicatorFragmentPagerAdapter {
        ...
        public View getViewForTab(int position, View convertView, ViewGroup container) {
            if (convertView == null) {
                convertView = inflate.inflate(R.layout.item_live_tab, container, false);
            }
        ...
        public Fragment getFragmentForPage(int position) {
            LiveLeftFragment mainFragment = new LiveLeftFragment();
            Bundle bundle = new Bundle();
            bundle.putString(LiveLeftFragment.INTENT_STRING_TABNAME, tabName);
            bundle.putInt(LiveLeftFragment.INTENT_INT_POSITION, position);
